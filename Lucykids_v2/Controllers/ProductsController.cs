...
namespace Lucykids_v2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var storeDbContext = _context.Products.Include(p => p.Brand).Include(p => p.Size);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,BrandId,SizeId,Gender")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Price,BrandId,SizeId,Gender")] Product product)
        {
